...
const managementItems = [
    ...
    { name: 'Personal HSE', icon: ShieldCheck, path: '/personal-hse' },
    { name: 'Centros de Costo', icon: Map, path: '/centros-costo' },
    { name: 'Empresas Cliente', icon: Building2, path: '/empresas-cliente' },
];

const formItems = [
    { name: 'Reporte diario de permisos', icon: FileText, path: '/reportes', badge: 12 },
    { name: 'Reporte de asistencia', icon: Users, path: '/asistencia' },
    { name: 'Reporte de eventos', icon: ShieldCheck, path: '/eventos-accidentes' },
    { name: 'Reporte de Novedades', icon: BarChart3, path: '/novedades' },
    { name: 'Reporte de Ausentismo', icon: Calendar, path: '/ausentismo' },
    { name: 'Ocurrio asi', icon: FileText, path: '/ocurrio-asi' },
];
            ...
            <div className="flex-1 space-y-8 overflow-y-auto scrollbar-hide pr-1">
                <div className="space-y-3">
                    ...
                    <nav className="space-y-1">
                        ...
                        {/* 3, 4, 5. Management Items (Personal, Centros, Empresas) */}
