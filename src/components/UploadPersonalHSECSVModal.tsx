...
import { createSupervisorHSE } from '../services/hseService';

interface UploadPersonalHSECSVModalProps {
    isOpen: boolean;
    onClose: () => void;
    onUploadSuccess: () => void;
}

export const UploadPersonalHSECSVModal: React.FC<UploadPersonalHSECSVModalProps> = ({ isOpen, onClose, onUploadSuccess }) => {
    ...
    const handleDownloadTemplate = () => {
        ...
        const templateHeaders = "Nombre;Cargo;Area;Estado;Correo;Telefono\n";
        const sampleData = "Carlos Mario Ruiz;Supervisor HSE Senior;Planta Sur;Activo;carlos@empresa.com;3001234567\n";
        ...
        link.setAttribute("download", "plantilla_supervisores_hse.csv");
            ...
            <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl relative flex flex-col max-h-[90vh]">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100 shrink-0">
                    <div className="flex flex-col">
                        <h2 className="text-xl font-black tracking-tight text-brand-text">Carga Masiva de Supervisores HSE</h2>
                        ...
                        <>
                            <div className="p-4 bg-brand-primary/5 border border-brand-primary/20 rounded-2xl">
                                ...
                                <ul className="text-sm text-brand-text-muted space-y-2 font-medium">
                                    ...
                                    <li>3. Guarda el archivo como CSV, súbelo aquí y procesa la carga.</li>
                                </ul>
                            </div>
