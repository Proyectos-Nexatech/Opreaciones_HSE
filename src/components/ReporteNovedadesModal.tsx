...
interface ReporteNovedadesModalProps {
    isOpen: boolean;
    onClose: () => void;
            ...
            <div className="bg-white rounded-[40px] w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl border border-white/20 animate-in zoom-in-95 duration-300 flex flex-col">
                ...
                <div className="bg-brand-primary p-8 text-white flex justify-between items-center relative overflow-hidden shrink-0">
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-black tracking-tight">{initialData ? 'Editar Novedad' : 'Nuevo Reporte de Novedad'}</h2>
                            <p className="text-white/70 text-xs font-bold uppercase tracking-[0.2em]">Bitácora Operativa Digital</p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-10 custom-scrollbar">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="md:col-span-2 space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-6 py-4 text-sm font-bold text-brand-text focus:outline-none focus:ring-4 focus:ring-brand-primary/10 transition-all shadow-inner"
                                placeholder="Resumen corto de la novedad..."
                            />
                        </div>
                        ...
                        <div className="md:col-span-2 space-y-2">
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full bg-gray-50 border border-gray-100 rounded-3xl px-6 py-4 text-sm font-bold text-brand-text focus:outline-none focus:ring-4 focus:ring-brand-primary/10 transition-all shadow-inner resize-none"
                                placeholder="Describa extensamente lo sucedido o el motivo de la novedad..."
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 pt-10">
                        ...
                        >
                            ...
                            {initialData ? 'Guardar Cambios' : 'Registrar Novedad'}
                        </button>
                    </div>
                </form>
            </div>
