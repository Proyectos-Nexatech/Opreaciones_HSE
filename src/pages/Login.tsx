                    ...
                    <div className="max-w-xs mx-auto w-full">
                        ...
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            <div className="flex items-center pt-1">
                                ...
                                />
                                <label htmlFor="remember-me" className="ml-2 block text-xs text-gray-400 font-medium cursor-pointer select-none">
                                    Recordarme
                                </label>
                            </div>
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 lg:py-2.5 border border-gray-100 rounded-xl bg-white text-xs font-bold text-gray-600 hover:bg-gray-50 transition-all duration-200"
                            >
                        ...
                        <div className="mt-8 text-center pt-6 border-t border-gray-50">
                            <p className="text-xs text-gray-400 font-medium">
                                ...
                                <Link to="/register" className="text-blue-500 font-black hover:underline underline-offset-4 transition-all">
                                    Regístrate
                                </Link>
                            </p>
                        </div>
