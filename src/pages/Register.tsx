...
export const Register = () => {
    ...
    if (success) {
        return (
            <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-gray-50">
                ...
                <div className="relative w-full max-w-lg bg-white rounded-[32px] shadow-2xl p-10 z-10 text-center animate-in zoom-in-95 duration-300">
                    ...
                    <button
                        ...
                        className="w-full py-4 px-6 rounded-2xl shadow-lg shadow-blue-500/20 text-sm font-black text-white bg-blue-500 hover:bg-blue-600 active:scale-[0.98] transition-all duration-200 uppercase tracking-widest"
                    >
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-gray-50">
            ...
            {/* Main Floating Card */}
            <div className="relative w-full max-w-4xl bg-white rounded-[32px] shadow-2xl flex flex-col lg:flex-row-reverse overflow-hidden min-h-[600px] z-10 animate-in fade-in zoom-in-95 duration-500">
                ...
                {/* Left Side: Form */}
                <div className="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white border-r border-gray-50">
                    <div className="max-w-xs mx-auto w-full">
                        ...
                        <p className="text-gray-400 text-sm font-medium mb-8">Comienza tu viaje con nosotros hoy.</p>
                        ...
                        <form onSubmit={handleRegister} className="space-y-5">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-5 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl text-gray-900 placeholder-gray-400 focus:bg-white focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/5 focus:outline-none transition-all text-sm font-medium"
                            ...
                            <div className="pt-2">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full flex items-center justify-center gap-2 py-4 px-6 rounded-2xl shadow-xl shadow-blue-500/25 text-sm font-black text-white bg-blue-500 hover:bg-blue-600 active:scale-[0.98] transition-all duration-200 uppercase tracking-widest"
                                >
                                    {loading ? (
