...
import { Search, Plus, Mail, Phone, MapPin, Eye, Edit3, Trash2, ShieldCheck, Loader2, X, AlertTriangle } from 'lucide-react';
                ...
                {supervisors.length === 0 && (
                    <div className="col-span-full py-20 text-center bg-gray-50/50 rounded-[40px] border-2 border-dashed border-gray-100">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <p className="text-brand-text-muted font-black text-sm tracking-widest uppercase">Cargando Personal HSE...</p>
                        </div>
                    </div>
                )}
            </div>
